...
def SPs_initiation(accessible_grid_IDs, u, v,branches=2):
    ...
    print("u:{},data oram:{},pos oram:{}".format(u,len(clients[0].server.oram_blocks),len(
            clients[0].position_map.pos_client.server.oram_blocks)))
...
def getAnalyticalOCCTime(n, u, w, branching):
    ...
    max_load=max(balls_ino_bins_maxload(u, w),1)
